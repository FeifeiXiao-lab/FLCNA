...
#' @param lambda The tuning parameter \eqn{\lambda} in the penalty term. The default is 5.
...
#' output <- FLCNA(K = c(1:2), lambda = c(0,1), y=y)
#' output
#'
#' @export
FLCNA <- function(tuning=NULL, K=NULL, lambda = c(5), Y, N = 100, kms.iter = 100, kms.nstart = 100, 
