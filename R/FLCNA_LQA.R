...
#' @title flowCalcCpp
#' @description Matrix calculation using Rcpp package
#'
#' @export
...
#' 
FLCNA_LQA <- function(k, K1, index.max, y, mu.t.all, mu.no.penal, sigma.all, alpha, lambda, iter.num = 20, eps.LQA = 1e-5, eps.diff = 1e-5){
