# Generate simulation data using spike-in strategy for 5 clusters
########################################################################
...
setwd("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states")
set.seed(2021)
random.Cell <- sample(1:5,ncol(rd2),replace = TRUE)
save(random.Cell, file="random.Cell.5clusters.RData")
...
res <-Gen_simu(rd2=rd2, nCluster=5, nCNV=50, Percent=100)

setwd("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\Simulation100Percent")
...
res <-Gen_simu(rd2=rd2, nCluster=5, nCNV=50, Percent=80)

setwd("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\Simulation80Percent")
mix.CNVindex.list <- res$mix.CNVindex.list
save(mix.CNVindex.list, file="mix.CNVindex.list.RData")
...
res <-Gen_simu(rd2=rd2, nCluster=5, nCNV=50, Percent=60)

setwd("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\Simulation60Percent")
mix.CNVindex.list <- res$mix.CNVindex.list
save(mix.CNVindex.list, file="mix.CNVindex.list.RData")
...
res <-Gen_simu(rd2=rd2, nCluster=5, nCNV=50, Percent=40)

setwd("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\Simulation40Percent")
mix.CNVindex.list <- res$mix.CNVindex.list
save(mix.CNVindex.list, file="mix.CNVindex.list.RData")
...
res <-Gen_simu(rd2=rd2, nCluster=5, nCNV=50, Percent=20)

setwd("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\Simulation20Percent")
mix.CNVindex.list <- res$mix.CNVindex.list
save(mix.CNVindex.list, file="mix.CNVindex.list.RData")
...
for (Percent in c(100, 80, 60, 40, 20)){
  ...
  for (CNVtype in c("Ddel","Sdel","mix","Sdup","Ddup")){
    ...
    method <- "FLCNV"
    pre_cluster <- get(load("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\random.Cell.5clusters.RData"))
    output<- get(load(paste0("E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\Simulation",Percent,"Percent\\",
    ...
    #CONET Evaluation of simulation results 
    method <- "CONET"
    output <- read.table(paste0("H:\\CONET\\Percent", Percent, "\\SuperShort\\", CNVtype, "\\", CNVtype,"\\out\\inferred_attachment"), sep=";")
    CONET_SuperShort <- ARI(output$V3,pre_cluster)
    
    output <- read.table(paste0("H:\\CONET\\Percent", Percent, "\\Short\\", CNVtype, "\\", CNVtype,"\\out\\inferred_attachment"), sep=";")
    CONET_Short <- ARI(output$V3,pre_cluster)
    
    output <- read.table(paste0("H:\\CONET\\Percent", Percent, "\\Medium\\", CNVtype, "\\", CNVtype,"\\out\\inferred_attachment"), sep=";")
    CONET_Medium <- ARI(output$V3,pre_cluster)
    
    output <- read.table(paste0("H:\\CONET\\Percent", Percent, "\\Long\\", CNVtype, "\\", CNVtype,"\\out\\inferred_attachment"), sep=";")
    CONET_Long <- ARI(output$V3,pre_cluster)
    ...
    data1 <- data.frame(
      ...
      HMM_Hclus=c(HMM_Hclus_SuperShort, HMM_Hclus_short, HMM_Hclus_medium, HMM_Hclus_long),
      HMM_kmeans=c(HMM_kmeans_SuperShort, HMM_kmeans_short, HMM_kmeans_medium, HMM_kmeans_long),
      CONET=c(CONET_SuperShort, CONET_Short, CONET_Medium, CONET_Long))
...
# write.csv(Final.output, file="E:\\10XGenomics\\breast_tissue_ABCDE_10k\\Simulation 5 clusters 5 states\\Simu_eval_output_5cluster_ARI.csv")
