...
fastq_dir=$kim/fastq/paired
bam_dir=$kim/fastq/pair_bam
cd $fastq_dir

total_files=`find -name '*_1.fastq' | wc -l`
arr=( $(ls *_1.fastq) )
...
bwa mem -t 4 $kim/hg19.fa ${sample_name:0:10}_1.fastq ${sample_name:0:10}_2.fastq> $bam_dir/${sample_name:0:10}.sam
